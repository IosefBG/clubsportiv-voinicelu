...
<div class="container-fluid">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        ...
        <h3 class="text-dark mb-0">Echipa</h3>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="row">
                ...
                for($i = 1 ; $i <= 9; $i++){
                    ...
                    echo '                <h6 class="mb-0">';
                    echo '                    <div class="text-center"><strong>Fundal '.$i.'</strong></div>';input_dictionary("echipa_nume_".$i);
                    echo '                </h6>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </li>';
                    ...
                    echo '                <h7 class="mb- ">';
                    echo '                    <div class="text-center"><strong>Content '.$i.'</strong></div>';input_dictionary("echipa_funct_".$i);
                    echo '                </h7>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </li>';
